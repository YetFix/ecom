                    ...
                    <div class="container">
                            ...
                            <ul>
                                <li class="menu-item">
                                    <a title="Hotline: (+123) 456 789" href="#"><span
                                            class="icon label-before fa fa-mobile"></span>Hotline: (+880) 1681046437</a>
                                </li>
                            </ul>
                        </div>
                        <div class="topbar-menu right-menu">
                            <ul>
                                ...
                                @else
                                <li class="menu-item menu-item-has-children parent">
                                    <a title="My Account" href="/user/myaccount">My Account({{Auth::user()->name}})<i
                                            class="fa fa-angle-down" aria-hidden="true"></i></a>
                                    <ul class="submenu curency">
                                        <li class="menu-item">
                ...
                <div class="container">
                    <div class="mid-section main-info-area">
                        ...
                        <div class="wrap-logo-top left-section">
                            <a href="/" class="link-to-home "><img class="yet"
                                    ...
                                    <div class="wrap-contact-detail">
                                        <ul>
                                            <li>
                                                ...
                                                <p class="contact-txt">kha-225 Centuryy Center,Badda,Dhaka-1212</p>
                                            </li>
                                            <li>
                                                <i class="fa fa-phone" aria-hidden="true"></i>
                                                <p class="contact-txt">(+880) 1681046437</p>
                                            </li>
                                            <li>
                                                <i class="fa fa-envelope" aria-hidden="true"></i>
                                                <p class="contact-txt">info@yetshop.com</p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="wrap-footer-item">
                                ...
                                <div class="item-content">
                                    <div class="wrap-hotline-footer">
                                        ...
                                        <b class="phone-number">(+880) 01681046437</b>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="coppy-right-box">
                <div class="container">
                    <div class="coppy-right-item item-left">
                        <p class="coppy-right-text">Copyright © 2021 YetFix Ltd. All rights reserved</p>
                    </div>
